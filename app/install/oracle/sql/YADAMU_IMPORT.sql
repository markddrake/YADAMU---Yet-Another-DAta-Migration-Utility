...
--
  ...
  C_XML_STORAGE_MODEL  constant VARCHAR2(32) := 'CLOB';
...
--
  ...
  function GENERATE_SQL(P_SOURCE_VENROR VARCHAR2,P_TARGET_SCHEMA VARCHAR2, P_TABLE_OWNER VARCHAR2, P_TABLE_NAME VARCHAR2, P_SPATIAL_FORMAT VARCHAR2 DEFAULT 'WKB', P_COLUMN_LIST CLOB, P_DATA_TYPE_ARRAY CLOB, P_SIZE_CONSTRAINTS CLOB, P_JSON_STORAGE_MODEL VARCHAR2 DEFAULT C_JSON_STORAGE_MODEL, P_XMLTYPE_STORAGE_MODEL VARCHAR2 DEFAULT C_XML_STORAGE_MODEL) return TABLE_INFO_RECORD;
--
$ELSE
--
  function GENERATE_SQL(P_SOURCE_VENROR VARCHAR2,P_TARGET_SCHEMA VARCHAR2, P_TABLE_OWNER VARCHAR2, P_TABLE_NAME VARCHAR2, P_SPATIAL_FORMAT VARCHAR2 DEFAULT 'WKB', P_COLUMNS_XML XMLTYPE, P_DATA_TYPES_XML XMLTYPE, P_SIZE_CONSTRAINTS_XML XMLTYPE, P_JSON_STORAGE_MODEL VARCHAR2 DEFAULT C_JSON_STORAGE_MODEL, P_XMLTYPE_STORAGE_MODEL VARCHAR2 DEFAULT C_XML_STORAGE_MODEL) return TABLE_INFO_RECORD;
--
$END  
--
  function GENERATE_STATEMENTS(P_METADATA IN OUT NOCOPY BLOB,P_TARGET_SCHEMA VARCHAR2 DEFAULT SYS_CONTEXT('USERENV','CURRENT_SCHEMA'), P_SPATIAL_FORMAT VARCHAR2 DEFAULT 'WKB', P_JSON_STORAGE_MODEL VARCHAR2 DEFAULT C_JSON_STORAGE_MODEL) return CLOB;
...
$IF YADAMU_FEATURE_DETECTION.JSON_PARSING_SUPPORTED $THEN 
--
function GENERATE_SQL(P_SOURCE_VENROR VARCHAR2,P_TARGET_SCHEMA VARCHAR2, P_TABLE_OWNER VARCHAR2, P_TABLE_NAME VARCHAR2, P_SPATIAL_FORMAT VARCHAR2 DEFAULT 'WKB', P_COLUMN_LIST CLOB, P_DATA_TYPE_ARRAY CLOB, P_SIZE_CONSTRAINTS CLOB, P_JSON_STORAGE_MODEL VARCHAR2 DEFAULT C_JSON_STORAGE_MODEL, P_XMLTYPE_STORAGE_MODEL VARCHAR2 DEFAULT C_XML_STORAGE_MODEL)
--
$ELSE
--
function GENERATE_SQL(P_SOURCE_VENROR VARCHAR2,P_TARGET_SCHEMA VARCHAR2, P_TABLE_OWNER VARCHAR2, P_TABLE_NAME VARCHAR2, P_SPATIAL_FORMAT VARCHAR2 DEFAULT 'WKB', P_COLUMNS_XML XMLTYPE, P_DATA_TYPES_XML XMLTYPE, P_SIZE_CONSTRAINTS_XML XMLTYPE, P_JSON_STORAGE_MODEL VARCHAR2 DEFAULT C_JSON_STORAGE_MODEL, P_XMLTYPE_STORAGE_MODEL VARCHAR2 DEFAULT C_XML_STORAGE_MODEL)
--            
$END       
--
...
$END
--
function GENERATE_STATEMENTS(P_METADATA IN OUT NOCOPY BLOB,P_TARGET_SCHEMA VARCHAR2 DEFAULT SYS_CONTEXT('USERENV','CURRENT_SCHEMA'), P_SPATIAL_FORMAT VARCHAR2 DEFAULT 'WKB', P_JSON_STORAGE_MODEL VARCHAR2 DEFAULT C_JSON_STORAGE_MODEL)
return CLOB
as
  V_RESULTS         CLOB;
...
begin
  ...
  for x in getStatements() loop
    ...
    V_TABLE_INFO := GENERATE_SQL(x.VENDOR,P_TARGET_SCHEMA, x.OWNER, x.TABLE_NAME, P_SPATIAL_FORMAT, x.COLUMN_LIST, x.DATA_TYPE_ARRAY, x.SIZE_CONSTRAINTS, P_JSON_STORAGE_MODEL);
