...
class DBReader extends Readable {  
  ...
  getReader() {
	// dbReader.js provides the ordered event stream for random (database based) readers. For stream based readers the event stream is generated by the reader ist
