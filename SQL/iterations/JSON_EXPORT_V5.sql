...
**  VERSION 5
**
**  Add support for ANYDATA, OBJECTS and COLLECTIONS by generating a WITH CLAUSE with custom PL/SQL code for each object
**  Code is generated using Package &CURRENT_SCHEMA..OBJECT_SERIALIZATION
**
*/
