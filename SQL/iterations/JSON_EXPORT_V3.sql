...
**
**  Impliment simple SQL-based work arounds for unsupported data types where possible.
**  Output the column name and data type of the column for data types where a simple workaround is not possible
**
*/
  ...
  select aat.owner
	    ...
	    ,cast(collect(
			   case
				 ...
				 **
				 */
			   	 when DATA_TYPE in ('LONG','LONG RAW','BFILE','BLOB','ANYDATA')
