...
call %YADAMU_BIN%\import.bat RDBMS=%YADAMU_VENDOR%  USERID=%DB_USER%/%DB_PWD%@%DB_CONNECTION%  FILE=%YADAMU_IMPORT_MYSQL%\%FILENAME%.json ENCRYPTION=false TO_USER=\"%SCHEMA%%SCHEMA_VERSION%\"  MODE=%MODE% LOG_FILE=%YADAMU_IMPORT_LOG% EXCEPTION_FOLDER=%YADAMU_LOG_PATH%
...
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_SQL_PATH%\RECREATE_SCHEMA.sql %YADAMU_LOG_PATH% %SCHEMA%%SCHEMA_VERSION% 
call %YADAMU_BIN%\import.bat RDBMS=%YADAMU_VENDOR%  USERID=%DB_USER%/%DB_PWD%@%DB_CONNECTION%  FILE=%YADAMU_OUTPUT_PATH%\%FILENAME%%PRIOR_VERSION%.json ENCRYPTION=false TO_USER=\"%SCHEMA%%SCHEMA_VERSION%\"  MODE=%MODE% LOG_FILE=%YADAMU_IMPORT_LOG% EXCEPTION_FOLDER=%YADAMU_LOG_PATH%
...
call %YADAMU_BIN%\export.bat RDBMS=%YADAMU_VENDOR%  USERID=%DB_USER%/%DB_PWD%@%DB_CONNECTION%  FILE=%YADAMU_OUTPUT_PATH%\%FILENAME%2.json  ENCRYPTION=false FROM_USER=\"%SCHEMA%%SCHEMA_VERSION%\"  MODE=%MODE% LOG_FILE=%YADAMU_EXPORT_LOG%  EXCEPTION_FOLDER=%YADAMU_LOG_PATH%
set SCHEMA=jtest
set SCHEMA_VERSION=1
