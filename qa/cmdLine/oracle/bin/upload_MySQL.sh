...
source $YADAMU_BIN/upload.sh --RDBMS=$YADAMU_VENDOR USERID=$DB_USER/$DB_PWD@$DB_CONNECTION  FILE=$YADAMU_IMPORT_MYSQL/$FILENAME.json TO_USER=\"$SCHEMA$SCHEMA_VERSION\" MODE=$MODE LOG_FILE=$YADAMU_IMPORT_LOG  EXCEPTION_FOLDER=$YADAMU_LOG_PATH
...
sqlplus $DB_USER/$DB_PWD@$DB_CONNECTION @$YADAMU_SQL_PATH/RECREATE_SCHEMA.sql $YADAMU_LOG_PATH $SCHEMA$SCHEMA_VERSION 
source $YADAMU_BIN/upload.sh --RDBMS=$YADAMU_VENDOR USERID=$DB_USER/$DB_PWD@$DB_CONNECTION  FILE=$YADAMU_OUTPUT_PATH/$FILENAME$PRIOR_VERSION.json TO_USER=\"$SCHEMA$SCHEMA_VERSION\" MODE=$MODE LOG_FILE=$YADAMU_IMPORT_LOG  EXCEPTION_FOLDER=$YADAMU_LOG_PATH
