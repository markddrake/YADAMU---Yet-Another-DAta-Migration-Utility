...
source $YADAMU_BIN/import.sh --RDBMS=$YADAMU_VENDOR USERID=$DB_USER/$DB_PWD@$DB_CONNECTION  FILE=$YADAMU_IMPORT_MSSQL/$FILENAME.json ENCRYPTION=false TO_USER=\"$SCHEMA$SCHEMA_VERSION\" MODE=$MODE LOG_FILE=$YADAMU_IMPORT_LOG  EXCEPTION_FOLDER=$YADAMU_LOG_PATH
