call %YADAMU_HOME%\app\install\oracle19c\env\dbConnection.bat
...
call %YADAMU_HOME%\app\install\oracle18c\env\dbConnection.bat
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_MSSQL_ALL.sql %YADAMU_LOG_PATH% ""
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_SCHEMA.sql %YADAMU_LOG_PATH% jtest
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_SCHEMA.sql %YADAMU_LOG_PATH% sakila
call %YADAMU_HOME%\app\install\oracle12c\env\dbConnection.bat
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_MSSQL_ALL.sql %YADAMU_LOG_PATH% ""
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_SCHEMA.sql %YADAMU_LOG_PATH% jtest
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_SCHEMA.sql %YADAMU_LOG_PATH% sakila
call %YADAMU_HOME%\app\install\oracle11g\env\dbConnection.bat
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_MSSQL_ALL.sql %YADAMU_LOG_PATH% ""
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_SCHEMA.sql %YADAMU_LOG_PATH% jtest
sqlplus %DB_USER%/%DB_PWD%@%DB_CONNECTION% @%YADAMU_QA_HOME%\sql\oracle\sql\RECREATE_SCHEMA.sql %YADAMU_LOG_PATH% sakila
...
call %YADAMU_HOME%\app\install\mysql\env\dbConnection.bat
...
call %YADAMU_HOME%\app\install\mariadb\env\dbConnection.bat
...
call %YADAMU_HOME%\app\install\postgres\env\dbConnection.bat
