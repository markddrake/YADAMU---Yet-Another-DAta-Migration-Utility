...
source $YADAMU_TEST_HOME/sh/initializeLogging.sh
source $YADAMU_TEST_HOME/sh/installYadamu.sh
source $YADAMU_TEST_HOME/sh/createTestUsers.sh 1
#source $YADAMU_TEST_HOME/sh/createTestUsers.sh 2
