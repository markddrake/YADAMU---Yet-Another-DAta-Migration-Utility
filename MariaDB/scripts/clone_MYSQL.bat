...
node node\import --USERNAME=root --HOSTNAME=192.168.1.250 --PORT=3307 --PASSWORD=oracle --DATABASE=mysql --File=..\JSON\MYSQL\sakila.json toUser=sakila1
...
node node\import --USERNAME=root --HOSTNAME=192.168.1.250 --PORT=3307 --PASSWORD=oracle --DATABASE=mysql --File=JSON\MYSQL\sakila1.json toUser=sakila2
