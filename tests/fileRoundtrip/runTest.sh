...
export YADAMU_WORK_ID=fileRoundtrip
...
source $YADAMU_TEST_HOME/unix/createOutputFolders.sh $YADAMU_WORK_ROOT/oracle19c
...
source $YADAMU_TEST_HOME/unix/createOutputFolders.sh $YADAMU_WORK_ROOT/oracle11g
