...
node %YADAMU_DB_ROOT%\node\export --username=%DB_USER% --hostname=%DB_HOST% --password=%DB_PWD% --database=%DB_DBNAME% owner=\"AdventureWorksDW%SCHEMAVER%\"             file=%TGT%\AdventureWorksDW%FILEVER%.json mode=%MODE% logFile=%EXPORTLOG%
