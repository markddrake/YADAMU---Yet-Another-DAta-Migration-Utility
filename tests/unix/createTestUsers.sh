...
sqlplus $DB_USER/$DB_PWD@$DB_CONNECTION @$YADAMU_TEST_HOME/oracle/sql/RECREATE_MSSQL_ALL.sql $YADAMU_LOG_PATH $SCHMEAID Clarinet
sqlplus $DB_USER/$DB_PWD@$DB_CONNECTION @$YADAMU_TEST_HOME/oracle/sql/RECREATE_ORACLE_ALL.sql $YADAMU_LOG_PATH $SCHMEAID Clarinet DDL_AND_DATA
sqlplus $DB_USER/$DB_PWD@$DB_CONNECTION @$YADAMU_TEST_HOME/oracle/sql/RECREATE_SCHEMA.sql $YADAMU_LOG_PATH "jtest$SCHMEAID" Clarinet
sqlplus $DB_USER/$DB_PWD@$DB_CONNECTION @$YADAMU_TEST_HOME/oracle/sql/RECREATE_SCHEMA.sql $YADAMU_LOG_PATH "sakila$SCHMEAID" Clarinet
