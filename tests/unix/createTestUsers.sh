...
psql -U $DB_USER -d $DB_DBNAME -h $DB_HOST -a -vSCHEMA=JTEST$SCHEMAID -f $YADAMU_HOME/tests/postgres/sql/RECREATE_SCHEMA.sql >> $YADAMU_LOG_PATH/RECREATE_SCHEMA.log
psql -U $DB_USER -d $DB_DBNAME -h $DB_HOST -a -vSCHEMA=SAKILA$SCHEMAID -f $YADAMU_HOME/tests/postgres/sql/RECREATE_SCHEMA.sql >> $YADAMU_LOG_PATH/RECREATE_SCHEMA.log
exit /b