...
$service = Get-Service -Name OracleOraDB21Home1TNSListener -ErrorAction SilentlyContinue
if($service -eq $null) {
  $NOW = Get-Date -Format "o"
  Write-Output "$NOW Oracle: Creating Network Service ""OracleOraDB21Home1TNSListener""."
