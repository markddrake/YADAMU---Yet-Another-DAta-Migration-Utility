...
$service = Get-Service -Name OracleOraDB18Home1TNSListener -ErrorAction SilentlyContinue
if($service -eq $null) {
  $NOW = Get-Date -Format "o"
  Write-Output "$NOW Oracle: Creating Network Service ""OracleOraDB18Home1TNSListener""."
