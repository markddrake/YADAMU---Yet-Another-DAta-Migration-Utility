...
MODIFY FILE (
  NAME = templog, 
  FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\templog.ldf'
);
go
ALTER DATABASE msdb
MODIFY FILE (
...
MODIFY FILE (
  NAME = MSDBLog,
  FILENAME = 'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\MSDBLog.ld'
);
go
