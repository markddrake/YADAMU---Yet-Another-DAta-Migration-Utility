...
node $ENV:YADAMU_HOME/src/qa/cli/test.js CONFIG=$ENV:YADAMU_QA_HOME/regression/$ENV:YADAMU_TASK.json EXCEPTION_FOLDER=$ENV:YADAMU_LOG_PATH 2>&1 | tee $ENV:YADAMU_LOG_PATH/$ENV:YADAMU_TASK.log 