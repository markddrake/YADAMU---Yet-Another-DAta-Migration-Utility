docker build -t yadamu/svr-2022:vs22             --file=c:\Docker\Build\YADAMU\Windows\dockerfile.2022.vs22         c:\Docker\Build\YADAMU\Windows
docker build -t yadamu/svr-2022:vs13             --file=c:\Docker\Build\YADAMU\Windows\dockerfile.2022.vs13         c:\Docker\Build\YADAMU\Windows
docker build -t yadamu/svr-2019:vs22             --file=c:\Docker\Build\YADAMU\Windows\dockerfile.2019.vs22         c:\Docker\Build\YADAMU\Windows
docker build -t yadamu/svr-2019:vs13             --file=c:\Docker\Build\YADAMU\Windows\dockerfile.2019.vs13         c:\Docker\Build\YADAMU\Windows
docker build -t yadamu/svr-2016:vs22             --file=c:\Docker\Build\YADAMU\Windows\dockerfile.2016.vs22         c:\Docker\Build\YADAMU\Windows
