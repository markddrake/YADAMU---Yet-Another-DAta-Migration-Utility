...
docker build -t yadamu/base:latest . -f docker/dockerfiles/linux/yadamu
docker build -t yadamu/regression:latest . -f docker/dockerfiles/linux/regression
docker build -t yadamu/secure:latest . -f docker/dockerfiles/linux/secure
docker build -t yadamu/commandline:latest . -f docker/dockerfiles/linux/commandLine
...
docker exec -it YADAMU-SMB sh /mount/clean.sh
