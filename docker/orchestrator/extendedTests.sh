...
run_test() {
    ...
    case "$test_name" in
        ...
        oracle21c)
            compose_up "docker/dockerfiles/linux/ORA2103-01.yml" "Oracle 21c"
            ...
            compose_down "docker/dockerfiles/linux/ORA2103-01.yml" "Oracle 21c"
            ;;
            
        oracle23ai)
            compose_up "docker/dockerfiles/linux/ORA2305-01.yml" "Oracle 23ai"
            
            # Tail Oracle container logs in background
            log_message "Monitoring Oracle 23ai startup logs..."
            docker logs -f ORA2305-01 2>&1 &
            ORACLE_LOG_PID=$!
            ...
            compose_down "docker/dockerfiles/linux/ORA2305-01.yml" "Oracle 23ai"
            ;;
            
        vertica09)
            compose_up "docker/dockerfiles/linux/VRTCA09-01.yml" "Vertica 9"
            ...
            compose_down "docker/dockerfiles/linux/VRTCA09-01.yml" "Vertica 9"
            ;;
            
        db2)
            compose_up "docker/dockerfiles/linux/IBMDB2-01.yml" "IBM DB2"
            wait_message "Waiting for IBM DB2 Startup (${DB2_STARTUP_WAIT}s)..."
            sleep "$DB2_STARTUP_WAIT"
            configure_database "db2" "IBMDB2-01"
            run_test_suite "db2"
            compose_down "docker/dockerfiles/linux/IBMDB2-01.yml" "IBM DB2"
            ;;
            
        cockroach)
            compose_up "docker/dockerfiles/linux/COCKROACH-01.yml" "CockroachDB"
            ...
            run_test_suite "cdb"
            compose_down "docker/dockerfiles/linux/COCKROACH-01.yml" "CockroachDB"
            ;;
            
        yugabyte)
            compose_up "docker/dockerfiles/linux/YUGABYTE-01.yml" "YugabyteDB"
            ...
            run_test_suite "ydb"
            compose_down "docker/dockerfiles/linux/YUGABYTE-01.yml" "YugabyteDB"
            ;;
        ...
        snowflake)
            ...
            compose_up "docker/orchestrator/snowflake/docker-compose.yml" "Snowflake"
            ...
            compose_down "docker/orchestrator/snowflake/docker-compose.yml" "Snowflake"
            ;;
            
        *)
            error_message "Unknown test: $test_name"
            echo "Available tests: cmdline, oracle11g, oracle19c, oracle21c, oracle23ai, vertica09, db2, cockroach, yugabyte, snowflake"
            exit 1
            ;;
    esac
