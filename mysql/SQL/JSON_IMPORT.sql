...
BEGIN
  ...
  PROCESS_TABLE : LOOP
	...
	SET P_RESULTS = JSON_ARRAY_APPEND(P_RESULTS,'$',JSON_OBJECT('tableName', V_TABLE_NAME, 'rowCount', V_ROW_COUNT, 'elapsedTime', V_ELAPSED_TIME, 'ddlStatement', V_DDL_STATEMENT, 'dmlStatement', V_DML_STATEMENT));
  END LOOP;
