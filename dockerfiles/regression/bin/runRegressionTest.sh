...
node $YADAMU_HOME/src/YADAMU_QA/common/node/test.js CONFIG=$YADAMU_QA_HOME/regression/$YADAMU_TASK.json EXCEPTION_FOLDER=$YADAMU_LOG_PATH 2>&1 | tee $YADAMU_LOG_PATH/$YADAMU_TASK.log 