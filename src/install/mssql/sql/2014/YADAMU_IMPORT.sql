...
go
--
ALTER FUNCTION sp_GENERATE_SQL(@VENDOR NVARCHAR(128), @SCHEMA NVARCHAR(128), @TABLE_NAME NVARCHAR(128), @COLUMN_NAMES_ARRAY XML, @DATA_TYPES_ARARY XML, @SIZE_CONSTRAINTS_ARRAY XML, @SPATIAL_FORMAT NVARCHAR(128), @CIRCLE_FORMAT NVARCHAR(7), @DB_COLLATION NVARCHAR(32)) 
returns NVARCHAR(MAX)
as
begin
...
ALTER FUNCTION sp_GENERATE_STATEMENTS(@TARGET_DATABASE VARCHAR(128), @SPATIAL_FORMAT NVARCHAR(128), @METADATA NVARCHAR(MAX),@DB_COLLATION NVARCHAR(32)) 
returns NVARCHAR(MAX)
as
begin
  ...
  select TABLE_NAME, 
         master.dbo.sp_GENERATE_SQL(VENDOR, @TARGET_DATABASE, v.TABLE_NAME, v.COLUMN_NAMES_ARRAY, v.DATA_TYPES_ARARY, v.SIZE_CONSTRAINTS_ARRAY, @SPATIAL_FORMAT, @CIRCLE_FORMAT, @DB_COLLATION) as STATEMENTS
