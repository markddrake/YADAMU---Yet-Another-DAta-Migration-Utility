...
mkdir $YADAMU_LOG_PATH/$YADAMU_DB
source $YADAMU_INSTALL/$YADAMU_DB/env/dbConnection.sh
mysql -u$DB_USER -p$DB_PWD -h$DB_HOST -D$DB_DBNAME -P$DB_PORT -v -f <$YADAMU_HOME/src/sql/$YADAMU_DB/YADAMU_IMPORT.sql  >$YADAMU_LOG_PATH/$YADAMU_DB/YADAMU_IMPORT.log
