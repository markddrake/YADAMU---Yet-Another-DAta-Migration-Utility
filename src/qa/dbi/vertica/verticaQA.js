...
class VerticaQA extends YadamuQALibrary.qaMixin(VerticaDBI) {
    ...
    static get DBI_PARAMETERS()  { 
       this.#DBI_PARAMETERS = this.#DBI_PARAMETERS || Object.freeze(Object.assign({},Yadamu.DBI_PARAMETERS,VerticaConstants.DBI_PARAMETERS,Yadamu.QA_CONFIGURATION[VerticaConstants.DATABASE_KEY] || {},{RDBMS: VerticaConstants.DATABASE_KEY}))
