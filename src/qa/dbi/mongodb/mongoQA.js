...
class MongoQA extends YadamuQALibrary.qaMixin(MongoDBI) {
    ...
    static get DBI_PARAMETERS()  { 
       this.#DBI_PARAMETERS = this.#DBI_PARAMETERS || Object.freeze(Object.assign({},Yadamu.DBI_PARAMETERS,MongoConstants.DBI_PARAMETERS,Yadamu.QA_CONFIGURATION[MongoConstants.DATABASE_KEY] || {},{RDBMS: MongoConstants.DATABASE_KEY}))
