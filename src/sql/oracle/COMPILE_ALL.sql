...
begin
  ...
  DBMS_OUTPUT.put_line('YADAMU_FEATURE_DETECTION.C_JSON_DATA_TYPE:              ' || YADAMU_IMPORT.C_JSON_DATA_TYPE);
  DBMS_OUTPUT.put_line('YADAMU_FEATURE_DETECTION.C_BOOLEAN_DATA_TYPE:           ' || YADAMU_IMPORT.C_BOOLEAN_DATA_TYPE);
end;
/
spool off
--
