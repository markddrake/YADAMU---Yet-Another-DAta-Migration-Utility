...
function disableCopy(statusID) {
  ...
  status.classList.add('fa-question-circle')
}
...
function testConnection(button,status,connection,connectionProperties,parameters) {
  ...
  status.classList.remove('fa-question-circle')
  status.classList.remove('fa-check-circle')
  status.classList.remove('fa-times-circle')
...
function validateMsSQLSource(button) {
  ...
  , port                       : document.getElementById('source-mssql-port').value
...
function validateMsSQLTarget(button) {
  ...
  , port                       : document.getElementById('target-mssql-port').value
...
function loadConfiguration(configuration) {
    ...
    console.log('#source-tab a[href="#source-tab-' + sourceDatabase + '"]');
