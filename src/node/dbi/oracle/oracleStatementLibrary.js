...
`begin 
   :DATABASE_VERSION           := YADAMU_EXPORT.DATABASE_RELEASE(); 
   :MAX_STRING_SIZE            := YADAMU_FEATURE_DETECTION.C_MAX_STRING_SIZE; 
   :JSON_DB_STORAGE_MODEL      := YADAMU_IMPORT.C_JSON_DATA_TYPE; 
   :XMLTYPE_DB_STORAGE_CLAUSE  := YADAMU_IMPORT.C_XMLTYPE_STORAGE_CLAUSE; 
   :EXTENDED_STRING_SUPPORTED  := case when YADAMU_FEATURE_DETECTION.EXTENDED_STRING_SUPPORTED    then YADAMU_UTILITIES.C_TRUE else YADAMU_UTILITIES.C_FALSE end;
   :JSON_PARSING_SUPPORTED     := case when YADAMU_FEATURE_DETECTION.JSON_PARSING_SUPPORTED       then YADAMU_UTILITIES.C_TRUE else YADAMU_UTILITIES.C_FALSE end;
   :NATIVE_JSON_TYPE           := case when YADAMU_FEATURE_DETECTION.JSON_DATA_TYPE_SUPPORTED     then YADAMU_UTILITIES.C_TRUE else YADAMU_UTILITIES.C_FALSE end;
   :BOOLEAN_DB_STORAGE_MODEL   := YADAMU_IMPORT.C_BOOLEAN_DATA_TYPE; 
   :NATIVE_BOOLEAN_TYPE        := case when YADAMU_FEATURE_DETECTION.BOOLEAN_DATA_TYPE_SUPPORTED  then YADAMU_UTILITIES.C_TRUE else YADAMU_UTILITIES.C_FALSE end;
 end;`;
...
const _SQL_SCHEMA_INFORMATION = `select * from table(YADAMU_EXPORT.GET_SCHEMA_METADATA(:P_OWNER_LIST,:P_OPTIONS))`;
