...
class YugabyteStorageOptions extends YadamuStorageOptions {

  get JSON_TYPE()                           { return YugabyteConstants.JSON_STORAGE_OPTION }	

  set JSON_TYPE(v)                          { YadamuDataTypes.redefineProperty(this,'JSON_TYPE',v) }
  	
}

class YugabyteDataTypes extends YadamuDataTypes {
...
coalesceTypeMappings(typeList) {
  ...
  get STORAGE_OPTIONS()   { return new YugabyteStorageOptions() }

}
 
export { YugabyteDataTypes as default }