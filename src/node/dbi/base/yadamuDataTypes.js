...
class YadamuDataTypes {
  ...
  get DOUBLE_TYPE()                         {
    throw new YadamuError(`Must supply explicit data type mapping for 'DOUBLE_TYPE'`)
  }
  ...
  get FLOAT_TYPE()                          { return this.DOUBLE_TYPE }
  ...
  get DATE_TYPE()                           { return this.DATETIME_TYPE }
                                                   
  set DATE_TYPE(v)                          { YadamuDataTypes.redefineProperty(this,'DATE_TYPE',v) }
                                                   
  get TIME_TYPE()                           { return this.DATETIME_TYPE }
  ...
  get MSSQL_DATETIME_TYPE()                 { return this.DATETIME_TYPE }
                                                    
  set MSSQL_DATETIME_TYPE(v)                { YadamuDataTypes.redefineProperty(this,'MSSQL_DATETIME_TYPE',v) }
  ...
  get SNOWFLAKE_VARIANT_TYPE()              { return this.BLOB_TYPE }
...
0
  ...
  static isUnboundedNumeric(vendor,dataType) {
    return this.WELLKNOWN_UNBOUNDED_NUMERIC_TYPES[vendor] === dataType
  }
