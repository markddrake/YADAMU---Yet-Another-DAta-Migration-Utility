...
node node\import userid=SYSTEM/oracle@ORCL18c File=..\JSON\MYSQL\sakila.json toUser=sakila1
...
node node\import userid=SYSTEM/oracle@ORCL18c File=JSON\ORCL18c\MYSQL\sakila1.json touser=sakila2
