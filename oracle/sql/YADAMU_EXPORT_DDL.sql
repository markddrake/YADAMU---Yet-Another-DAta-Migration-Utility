...
$IF NOT JSON_FEATURE_DETECTION.CLOB_SUPPORTED $THEN
  function FETCH_DLL_RESULTS return CLOB;
$END
--
$END
--
...
as
  ...
  V_SOURCE_SCHEMA     VARCHAR2(128) := JSON_VALUE(P_EXPORT_CONTENTS,'$.systemInformation.schema');
...
begin
  ...
  for s in getDDLStatements loop
    ...
    V_ABORT_DDL_OPERATIONS := APPLY_DDL_STATEMENT(V_DDL_STATEMENT,V_SOURCE_SCHEMA,P_TARGET_SCHEMA);
  end loop;
